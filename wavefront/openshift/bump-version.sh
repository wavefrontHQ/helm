...
PR_URL=$(curl \
  ...
  \"body\":\"Review checklist:
   1. Verify modifications to wavefront/openshift/values.yaml are reflected in wavefront/values.schema.json
   2. Verify any wavefront/README.md changes have made it to wavefront/openshift/README.md
