...
sshpass -p "${OPENSHIFT_CREDS_PSW}" ssh -o StrictHostKeyChecking=no -tt root@${OPENSHIFT_VM} 'bash -s' < wavefront/openshift/test-and-generate-report.sh ${WAVEFRONT_TOKEN}
